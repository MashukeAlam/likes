...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature" do
    assert_difference("Feature.count") do
      post features_url, params: { feature: { feature_name: @feature.feature_name, link: @feature.link, reward: @feature.reward } }
    end
  ...
  test "should update feature" do
    patch feature_url(@feature), params: { feature: { feature_name: @feature.feature_name, link: @feature.link, reward: @feature.reward } }
